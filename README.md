...
<details>
  ...
  <ul>
    <li><a href="https://www.postgresql.org/docs/current/" target="_blank">PostgreSQL</a></li>
  </ul>
</details>
...
```bash
  git clone https://github.com/fezzopro/vet-clinic-database.git
```
...
Feel free to check the [issues page](https://github.com/fezzopro/vet-clinic-database/issues).
